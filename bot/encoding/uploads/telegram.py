import config; download_dir = config.DOWNLOAD_DIR


import os
import time

import logging; log = logging.getLogger("encoding")
from bot.encoding.db import enc_db as db
from bot.encoding.display_progress import progress_for_pyrogram
from bot.encoding.encoding import get_duration, get_thumbnail, get_width_height
